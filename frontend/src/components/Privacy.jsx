      ...
      <div className="privacy-text">
        <ol>
          ...
          <li>
            ...
            <ol type="i">
              <li>
                Internet Protocol (IP) address of the domain from which you
                access the Internet, either your individual address or the proxy
              ...
              <li>
                Web address of the site from which you linked directly to our
                App.
              </li>
          ...
          <li>
            <p>
              SPF is the sole owner of the information collected on this App.
              The App collects personally identifiable information from our
              users at several different points on our App.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              The App does not create individual profiles with the information
              you provide. If information is collected, it will be used solely
              in connection with Police@SG, or for such other purposes as are
          ...
          <li>
            <p>
              ...
              the App, we may share necessary data with other Government
              agencies, so as to provide Whole of Government services to you in
              an efficient and effective way, unless such sharing is prohibited
              by law. We will NOT share your personal data with non-Government
              entities, except where such entities have been authorised to carry
          ...
          <li>
            <p>
              ...
              previously supplied us or other Government agencies. This will
              speed up the transaction and save you the trouble of repeating
              previous submissions. Should the data be out-of-date, please
              provide us with updated and accurate data. We will retain your
              personal data only to the extent necessary for the effective
